...
plot_in_frequency(real(fftshift(fft(yt))),fs, 'Message in frequency domain');
...
plot_in_time(St, fs_res, 'NBFM modulated signal in time domain');
plot_in_frequency(abs(fftshift(fft(St))),fs_res,'NBFM modulated signal in Frequency domain');
...
plot_in_time(yt_demod,fs,'NBFM demodulated signal in time domain using envelope detector');
plot_in_frequency(yf_demod,fs,'NBFM demodulated signal in frequency domain using envelope detector');
